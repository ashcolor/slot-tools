...
import { TEMPLATE_CATEGORIES } from "../../constants/slotMemo/template";
...
export function TemplateKeyboard({
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl border border-base-300 bg-base-100/95 backdrop-blur rounded-xl shadow-lg p-2">
